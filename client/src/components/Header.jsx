...
const Header = ({
  ...
  return (
    <div className="bg-[#dcefef] md:mt-24">
      <div
      ...
      >
        <div className="w-full z-10">
          <div className=" md:mt-6 mt-6">
            <p className="md:text-gray-900 text-gray-900   font-bold text-4xl">{title}</p>
          </div>
          <br /> <br />
          ...
          {type && (
            <div className="w-full lg:1/2 flex flex-wrap gap-3 md:gap-6 py-10 md:py-14">
              {popularSearch.map((search, index) => (
                <span
                  key={index}
                  className="bg-[#f2f2f9e6] md:text-[#1a1a1b]  py-1 px-2 rounded-full text-sm md:text-base"
                >
                  {search}
                </span>
              ))}
